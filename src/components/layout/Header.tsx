...
import logoMain from "@/assets/BP2.png";
...
const Header = () => {
  ...
  const navigation = [
    ...
    { name: "In Association With", href: "/inassociationwith" },
  ];

  const isActive = (path: string) => location.pathname === path;

  return (
    <header className="bg-background border-b border-border sticky top-0 z-50 shadow-card backdrop-blur-sm bg-background/95">
